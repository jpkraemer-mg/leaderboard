...
public interface BoardRepository extends JpaRepository<Board, UUID> {
  ...
  @Query(value = "SELECT * FROM board WHERE pending=0 AND level < 119989 ORDER BY level DESC LIMIT :limit", nativeQuery = true)
  ...
  @Query(value = "SELECT * FROM board WHERE level=119989 AND pending=0", nativeQuery = true)
